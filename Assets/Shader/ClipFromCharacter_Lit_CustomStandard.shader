...
Shader "Custom/Lit/ClipFromCharacter_Standard"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment fragBaseWithClipping
            ...
            half4 fragBaseWithClipping (VertexOutputForwardBase i) : SV_Target
            {
                //return fragForwardBaseInternal(i);
                return fragForwardBaseInternalWithClipping(i, _PivotPoint, _CutoffDistance, _IsStartGame);
            }
