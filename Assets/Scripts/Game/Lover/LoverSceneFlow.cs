...
namespace Game.LV
{
    public class LoverSceneFlow : SceneFlow
    {
        ...
        private void Start()
        {
            ...
            Rose.OnQuestFail += (GameManager.Instance.GameScene as LoverScene).SetScreenDarker;
        ...
        private IEnumerator GameFramework()
        {
            ...
            (GameManager.Instance.GameScene as LoverScene).SetScreenBrighter();
        }
